...
def stylize(style_transform_path, content_image_path, save_image_path, net):
    # Device
    ...
    with torch.no_grad():
        ...
        utils.saveimg(generated_image, save_image_path)

def stylize_folder_single(style_path, content_folder, save_folder, net):
    """
    ...
    with torch.no_grad():
        for image_name in images:
            ...
            try:
                ...
                print(f"{image_name} has been successfully saved")
            except:
                print(f"The image {image_name} cannot be processed")
...
# stylize("checkpoint_c2000.pth",
#         "/workspaces/Facial-Style-Transfer-for-Realistic-Artwork-Generation/data/test/test_1.jpeg")